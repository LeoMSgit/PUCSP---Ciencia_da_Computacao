...
typedef struct {
    PecaDomino pecas[MAX_PECAS]; // Número máximo de peças que podem ser colocadas na mão de cada jogador
    int quantidadePecas; // Quantidade de peças na mão
    bool jaJogou; // Variável para contar se o jogador já jogou
} Jogador;
