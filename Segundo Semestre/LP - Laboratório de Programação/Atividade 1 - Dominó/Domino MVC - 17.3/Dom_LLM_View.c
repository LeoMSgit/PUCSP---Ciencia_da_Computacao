...
void comprarPeca(Jogador *jogador) {
    ...
    if (monte.quantidadeRestante > 0) {
        ...
        jogador->pecas[jogador->quantidadePecas] = monte.pecasRestantes[sorteio];
        jogador->quantidadePecas++; // Atualiza a quantidade de peças do jogador
        jogador->contadorCompras++; // Incrementa o contador de compras
        ...
        printf("Voce comprou a peca [%d|%d]\n", 
            jogador->pecas[jogador->quantidadePecas - 1].lado1, 
            jogador->pecas[jogador->quantidadePecas - 1].lado2);
    } else {
    ...
    do {
        ...
        switch (opcao) {
            case 1:
                ...
                break;
            case 2:
                comprarPeca(&jogadores[0]); // Jogador [N] compra uma peça
                break;
            case 3:
