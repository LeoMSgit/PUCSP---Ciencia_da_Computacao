...
3) Java é 0-Based, as contagens de arrays sempre tem a posição inicial como a posição 0
4) A função Main sempre é escrita da seguinte forma: public static void main(String[] args) {}
...
5) A extensão do arquivo em java é ".java"

6) System.out.println("Olá") é a função print
7) Documentação no Java é feita através de um documento com o nome da classe em formato .html
